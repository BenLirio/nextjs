...
var useStyles = Object(_material_ui_core__WEBPACK_IMPORTED_MODULE_2__["makeStyles"])(function (theme) {
  return {
    root: {
      display: 'grid',
      gridTemplateColumns: '[full-start] minmax(50px, 1fr) [center-start] repeat(8, [col-start] minmax(min-content, 8rem) [col-end]) [center-end] minmax(50px, 1fr) [full-end]'
    },
    card: {}
  };
});
...
var RateABiz = function RateABiz(_ref) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, review.authorFirstName), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_2__["Typography"], {
    variant: "h5",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25
    ...
    __self: this
  }, review.title), __jsx(_material_ui_lab__WEBPACK_IMPORTED_MODULE_3__["Rating"], {
    name: "read-only",
    value: review.rating,
    readOnly: true,
    __source: {
...
//# sourceMappingURL=index.js.152a0f4d53171c2ced8c.hot-update.js.map