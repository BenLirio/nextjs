  ...
  grid: {
    template: {
      test: (_test = {}, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_test, "@media (min-width:".concat(value.xs).concat(unit, ")"), {
        background: '#000',
        gridTemplateColumns: "[full-start] 16px [center-start] repeat(4, [col-start] 1fr [col-end]) [center-end] 16px[full-end]"
...
//# sourceMappingURL=_app.js.71db3c8a15725780fb8e.hot-update.js.map