  ...
  grid: {
    template: {
      test: (_test = {}, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_test, "@media (min-width:".concat(value.xs).concat(unit, ")"), {
        gridTemplateColumns: "[full-start] 16px [center-start] repeat(4, [col-start] 5rem [col-end]) [center-end] 16px[full-end]"
...
//# sourceMappingURL=_app.js.9bbd1b4528fb0c7b3751.hot-update.js.map