    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          stats = _ref2.stats;
          return _context.abrupt("return", reviews.filter(function (_ref3) {
            var authorLastName = _ref3.authorLastName,
                createdDate = _ref3.createdDate,
                authorFirstName = _ref3.authorFirstName,
                rating = _ref3.rating,
                id = _ref3.id,
                text = _ref3.text,
                title = _ref3.title;
            return !!(authorFirstName && authorLastName && rating && id && text && title);
          }).map(function (review) {
            return {
...
//# sourceMappingURL=index.js.0b29d111ba1e708365dc.hot-update.js.map