  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          data = _context.sent;
          console.log("Show data fetched. Cound: ".concat(data.length));
          return _context.abrupt("return", {
            ratings: data.map(function (rating) {
              return rating;
            })
          });
...
//# sourceMappingURL=index.js.42bd2b26ee56b0099754.hot-update.js.map