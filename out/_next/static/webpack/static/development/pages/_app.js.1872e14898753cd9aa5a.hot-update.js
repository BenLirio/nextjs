  ...
  grid: {
    template: {
      test: (_test = {}, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_test, "@media (min-width:".concat(value.xs).concat(unit, ")"), {
        gridTemplateColumns: "[full-start] 1rem [center-start] repeat(4, [col-start] 1fr [col-end]) [center-end] 1rem [full-end]",
        gridColumnGap: '1rem'
...
//# sourceMappingURL=_app.js.1872e14898753cd9aa5a.hot-update.js.map